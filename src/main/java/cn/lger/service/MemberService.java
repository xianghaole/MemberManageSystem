...
public class MemberService {
    ...
    public Member findByMemberNameAndPassword(String memberName,String password){
        return memberDao.findByMemberNameAndPassword(memberName,password);
    }
    ...
    public Page<Member> findMembersByMemberName(Integer currentPage, String memberName){
        ...
        Pageable pageable = PageRequest.of(currentPage, 8, Sort.Direction.DESC, "id");
